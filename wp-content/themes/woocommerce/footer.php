<footer id="footer-main" class="footer-main container-fluid" style="margin-top: 500px;">
			<!-- Container -->
			<div class="container">
				<div class="row">
					<!-- Widget About -->
					<aside class="col-md-3 col-sm-6 col-xs-6 ftr-widget widget_about">
						...
						<div class="info">
							<p><i class="icon icon-Pointer"></i>Max Shop, Monastir 5000, Tunisia.</p>
							<p><i class="icon icon-Phone2"></i><a href="tel:(11)1234567890" title="Phone" class="phone">(216) 97 949 888</a></p>
							<p><i class="icon icon-Imbox"></i><a href="mailto:info@maxshop.com" title="info@maxshop.com">ridha.rahmi@hotmail.com</a></p>
						</div>
					</aside><!-- Widget About /- -->
					<!-- Widget Links -->
